...
function testEmptyClass() {
  ...
  var exp = '\ngoog.provide("ncnode.test.className");\n' +
            '\n\nncnode.test.className.core = require("className");';
...
function testAddFuncts() {
  ...
  var exp = '\ngoog.provide("c");\n' +
            ...
            '\n  return c.core.functName2();' +
            '\n};' +

            '\n/**\n * desc3\n * @return {ret.type}\n */\nc.prototype.functName3 = function() {' +
            '\n  return c.core.functName3();' +
            '\n};' +

            '\n/**\n * @param {type.ns} arg1\n */\nc.prototype.functName4 = ' +
              'function(arg1) {' +
            '\n  return c.core.functName4(arg1);' +
            '\n};' +
            ...
            '\n/**' +
              ...
              '\n */\nc.functName5 = ' +
              'function(arg1, arg2) {' +
            '\n  return c.core.functName5(arg1, arg2);' +
            '\n};' +
...
function testNodeRequire() {
  ...
  var exp = '\ngoog.provide("c");\n' +
            '\n\nc.core = alternateInitialisation();';
  assertEquals_(exp, c.toString());
};
